        ...
        <div class="card-body">
            <div class="form-row mb-3">
              <div class="col-4 text-center border-right mb-3">
                ...
                <p class="text-uppercase text-muted mb-1"><h4 class="mb-1">20일</h4></p>
              </div>
              <div class="col-4 text-center mb-3 ">
                <h4 class="mb-1">사용휴가</h4><br>
                <p class="text-uppercase text-muted mb-1"><h4 class="mb-1">3일</h4></p>
              </div>
              <div class="col-4 text-center border-left mb-3">
                <h4 class="mb-1">잔여휴가</h4><br>
                <p class="text-uppercase text-muted mb-1"><h4 class="mb-1">17일</h4></p><br>
              </div>
            </div>
        </div>
      </div> 
      ...
      <div class="wrapper">
        ...
        <div class="card-body">
            <form class="needs-validation" method="post">
              ...
              <button class="btn btn-outline-primary" type="submit" id="submit-btn">신청하기</button>
            </form>
        </div>
      </div>
      ...
      <div class="card shadow mb-5" style="margin-top: -10px;">
        <div style="margin-left: 20px; margin-top: 20px;">
          ...
          <form action="" method="get">
            ...
            <button class="btn btn-outline-primary" type="submit" id="search-btn">조회</button>
          </form>
        
        <c:if test="${empty dateCount}">
	        <h6 class="card-title">조회 결과 5건</h6>
        </c:if>  
