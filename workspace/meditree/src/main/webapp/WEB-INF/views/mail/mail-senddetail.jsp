            ...
            <div id="content">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <h5 class="card-title">받는사람 | 작성일</h5> 
                    <input type="text" readonly class="form-control" id="floatingInput" value="${vo.receiverName} | ${vo.enrollDate}">
                ...
                <div class="mt-4">
                    <a href="${root}/mail/sendlist" class="btn btn-secondary">목록</a>
