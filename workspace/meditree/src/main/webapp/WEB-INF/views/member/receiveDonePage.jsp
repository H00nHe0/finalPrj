      ...
      <div id="main">
        ...
        <div id="board">
          <div id="receive-manageForm-holder">
            <div>
              <div id="title">
                <h2 style="display: inline-block">수납완료 조회</h2>
              ...
              <table id="receipt-table">
                <thead id="btn-wrap">
                  <tr>
                    <td colspan="5">
                      <a href="${root}/member/receiveManage"
                        ><button
                          type="button"
                          class="head-btn"
                ...
                <tbody id="list-area">
                  <c:forEach items="${payDoneList}" var="p">
                    <tr class="receipt-row">
                      ...
                      <td id="receiptNo">${p.no}</td>
                      <td>${p.paName}</td>
                      <td>${p.paGender}</td>
                      <td id="jiDate">${p.jiDate}</td>
                      <td id="changeToName">${p.deptNo}</td>
                      <td>${p.name}</td>
                      <td>
              ...
              <div id="page-area">
                <c:if test="${pv.currentPage > 1}">
                  <a
                    href="${root}/member/receiveDonePage?page=${pv.currentPage-1}&searchType=${searchMap.searchType}&searchValue=${searchMap.searchValue}"
                    class="pagingLine"
                    >이전</a
                  >
                </c:if>
                ...
                >
                  <c:if test="${pv.currentPage != i}">
                    <a href="${root}/member/receiveDonePage?page=${i}">${i}</a>
                  </c:if>
                  <c:if test="${pv.currentPage == i}">
                    <a
                      style="
