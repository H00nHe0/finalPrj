					...
					<div id="printArea"
                      ...
                      -->
							...
							<tr>
								...
								<td colspan="3" width="200">${vo.prDate}- ${vo.no}호</td>
								<td width="30px" rowspan="3">의료기관</td>
								<td>명칭</td>
								<td colspan="2" width="100px">메디트리</td>
							</tr>
							<tr>
								<td rowspan="2" width="80">환자</td>
								<td>성&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;명</td>
								<td colspan="3">${vo.patientName}</td>
								<td>전화번호</td>
								<td colspan="2">( 031 ) 9306 - 0776</td>
							</tr>
							<tr>
								<td>주민등록번호</td>
								<td colspan="3">${vo.rrn}</td>
								<td>팩스번호</td>
								<td colspan="3">( 031 ) 9306 - 0777</td>
							</tr>
							<tr>
								<td rowspan="2">질병</td>
								<td rowspan="2" colspan="2">${vo.tmContent}</td>
								<td rowspan="2" width="50">처방<br>의료인
								</td>
